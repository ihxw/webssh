...
### 1.1 项目目标
创建一个基于 Web 的 SSH 终端应用，允许用户通过浏览器访问和管理远程服务器，提供安全、便捷的远程终端访问体验。
...
- 终端字体：'Courier New', monospace, '微软雅黑'
...
### 9.3 环境变量
- `WEBSSH_PORT`: 服务端口
- `WEBSSH_DB_PATH`: 数据库路径
- `WEBSSH_JWT_SECRET`: JWT 密钥
- `WEBSSH_ENCRYPTION_KEY`: 加密密钥
